  ...
  return (
    <section className="h-screen">
      <div className="container mx-auto py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">{tours.length > 0 ? tours.map((tour) => <TourCard key={tour.id} tour={tour} />) : <p>No tours available for this city.</p>}</div>
      </div>
    </section>
  );
};

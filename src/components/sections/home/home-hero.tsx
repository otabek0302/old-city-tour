  ...
  return (
    <section className="relative -top-8">
      <div className="container">
        <div className="relative md:min-h-[calc(100vh-2vh)] h-[100vh] max-h-[780px] rounded-[28px] overflow-hidden">
          {image && (
            <div className="absolute inset-0 z-0">
              ...
              <div className="absolute inset-0 min-[425px]:top-1/2 min-[425px]:left-1/2 min-[425px]:-translate-x-1/2 min-[425px]:-translate-y-1/2 flex items-center justify-center px-4">
                <div className="min-[425px]:w-96 max-w-full lg:max-w-2xl text-center">
